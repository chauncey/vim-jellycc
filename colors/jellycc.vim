...
" License:      MIT
"
" Tons of this based on Jellybeans.vim:
"
...
let colors_name = "jellycc"

if has("gui_running") || &t_Co == 88 || &t_Co > 255
  let s:low_color = 0
else
  let s:low_color = 1
endif
...
call s:X("StatusLine","000000","909090","italic","Black","White")
call s:X("StatusLineNC","ffffff","403c41","italic","White","Black")
call s:X("VertSplit","777777","403c41","italic","Black","Black")

call s:X("Folded","a0a8b0","353535","italic","black","")
